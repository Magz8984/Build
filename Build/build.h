...
void settings(){
  init();
  int done=applyTotalPlugins(getPluginNumber("plugins"));
  if(done==0){
    addSpace();
    addExtras("applicationName");
    addSpace();
    addExtras("version");
    addSpace();
    addExtras("mainClassName");
    addSpace();
    addExtras("archivesBaseName");
    addSpace();
    applyTotalRepositories(getPluginNumber("repositories"));
    addSpace();
    applyTotalDependencies(getPluginNumber("dependencies"));
    addSpace();
    addGradleRemove();
  }
  closeStream();
